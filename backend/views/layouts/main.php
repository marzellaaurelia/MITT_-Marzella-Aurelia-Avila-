                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?= Yii::$app->getHomeUrl(); ?>dist/img/boxed-bg.jpg" class="img-circle" alt="User Image" style="background-color: #3c8dbc;">
                                </li>
                                <!-- Menu Footer-->
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?= Yii::$app->getHomeUrl(); ?>dist/img/boxed-bg.jpg" class="img-circle" alt="User Image">
                    </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li <?= Yii::$app->controller->id == 'skill' ? 'class=active' : '' ?>>
                        <a href="<?= Url::toRoute(['/skill']) ?>">
                            <i class="fa fa-edit"></i> <span>Skill</span>
                        </a>
                    </li>
                    <li <?= Yii::$app->controller->id == 'masterlevel' ? 'class=active' : '' ?>>
                        <a href="<?= Url::toRoute(['/masterlevel']) ?>">
                            <i class="fa fa-file"></i> <span>Level Skill</span>
                        </a>
                    </li>
                </ul>
            </section>
